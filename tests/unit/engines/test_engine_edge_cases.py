...
def test_ca_oas_clawback_uses_2023_threshold():
    ...
    # Net income $89,000 = $80,500 pension + $8,500 OAS (OAS is taxable income).
    d = compute_ca_return([_f("T4A", "CA", pension_or_superannuation=80500)], 2023, province="ON",
...
def test_ca_oas_clawback_uses_2025_threshold():
    ...
    # Net income $92,000 = $83,500 pension + $8,500 OAS, still below the 2025 threshold.
    d = compute_ca_return([_f("T4A", "CA", pension_or_superannuation=83500)], 2025, province="ON",
                          user_answers={"oas_benefits": "8500"})
...
def test_ca_oas_clawback_2024_unchanged():
    ...
    over → 15% = $600.45."""
    # Net income $95,000 = $86,500 pension + $8,500 OAS (OAS is taxable income).
    d = compute_ca_return([_f("T4A", "CA", pension_or_superannuation=86500)], 2024, province="ON",
                          user_answers={"oas_benefits": "8500"})
